...
def get_eigs(n, ell):
    ...
    U1 = np.loadtxt(f"efs_{compare1}/snrnmais_files/eig_files/U{idx1}.dat")
    V1 = np.loadtxt(f"efs_{compare1}/snrnmais_files/eig_files/V{idx1}.dat")
    U2 = np.loadtxt(f"efs_{compare2}/snrnmais_files/eig_files/U{idx2}.dat")
    V2 = np.loadtxt(f"efs_{compare2}/snrnmais_files/eig_files/V{idx2}.dat")
    return (U1, V1), (U2, V2)
